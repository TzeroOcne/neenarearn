...
<div class="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
  ...
  <div class="mb-8 prose leading-6 text-gray-600 dark:text-gray-400">
    ...
    <p>
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vitae consequatur voluptatem rerum
      aut reiciendis nemo consectetur aliquid sunt, atque obcaecati doloribus autem possimus
      incidunt. Iusto non vero tenetur consequuntur deleniti.
    </p>
    <p>
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime recusandae omnis quo suscipit
      excepturi praesentium exercitationem quam enim, aut cum similique architecto in tenetur vel
      dolores atque voluptatum amet hic.
    </p>
    <p>
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vitae consequatur voluptatem rerum
      aut reiciendis nemo consectetur aliquid sunt, atque obcaecati doloribus autem possimus
