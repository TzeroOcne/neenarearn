...
<footer class="flex flex-col justify-center items-start max-w-2xl mx-auto w-full mb-8">
  ...
  <div class="w-full max-w-2xl grid grid-cols-1 gap-4 pb-16 sm:grid-cols-3">
    <div class="flex flex-col space-y-4">
      <a data-sveltekit-prefetch href="/" class={linkClass} aria-label={'Footer home link'}>Home</a>
      <a data-sveltekit-prefetch href="/about" class={linkClass} aria-label={'Footer about link'}>
        About
      </a>
      <a
    ...
    <div class="flex flex-col space-y-4">
      <a data-sveltekit-prefetch href="/users" class={linkClass} aria-label={'Footer tags link'}
        >Users</a
      >
      <a data-sveltekit-prefetch href="/settings" class={linkClass} aria-label={'Footer tags link'}
        >Settings</a
      >
      <a
        data-sveltekit-prefetch
